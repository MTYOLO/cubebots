...
public class TileEntityMarker extends TileEntity {
	...
	public void readFromNBT(NBTTagCompound tag) {
		...
		renderEntity = (Entity) (tag.getString("Entity").compareTo("NANANAN") != 0 && tag.getString("Entity").length() > 0 ? EntityList.createEntityByName(tag.getString("Entity"), worldObj) : null);
