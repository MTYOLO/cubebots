...
public abstract class AICubeBotTarget extends EntityAIBase {
	...
	public AICubeBotTarget(EntityCreature par1EntityCreature, boolean par2) {
		this(par1EntityCreature, par2, false);
	}

	public AICubeBotTarget(EntityCreature par1EntityCreature, boolean par2, boolean par3) {
		this.taskOwner = par1EntityCreature;
		this.shouldCheckSight = par2;
		this.nearbyOnly = par3;
	}

	public AICubeBotTarget(EntityLiving par1, float par3, boolean par5, boolean par6) {
		// TODO Fill this in.
	}
	...
	public boolean continueExecuting() {
		...
		if (entitylivingbase == null) {
			...
			if (this.taskOwner.getDistanceSqToEntity(entitylivingbase) > d0
					* d0) {
				return false;
			} else {
		...
		if (par1EntityLivingBase == null) {
			...
			if (!this.taskOwner.func_110176_b(
				...
				if (this.nearbyOnly) {
					...
					if (this.targetSearchStatus == 0) this.targetSearchStatus = this.canEasilyReach(par1EntityLivingBase) ? 1 : 2;
