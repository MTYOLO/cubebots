...
import T145.cubebots.entities.ai.AITameOcelots;
import T145.cubebots.entities.ai.AITameWolves;
...
public class CubeBotTamer extends CubeBot
{
	...
	public CubeBotTamer(World par1World)
	{
		super(par1World);
		texture = "cubebots/textures/cubeBotTamer.png";
	...
	{
		if(ai!=null && ai.list==markedWolf && Block.blocksList[worldObj.getBlockId(x, y, z)] == CubeBots.markerWolf) return true;
		if(ai!=null && ai.list==markedCat && Block.blocksList[worldObj.getBlockId(x, y, z)] == CubeBots.markerCat) return true;
		return false;
	}
